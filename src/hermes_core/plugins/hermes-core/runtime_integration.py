...
class RuntimeHotPath:
    ...
    def __new__(cls) -> 'RuntimeHotPath':
    ...
    def execute_tool(
        ...
        try:
            ...
            logger.debug("runtime: goal registration failed: %s", exc)
        ...
        try:
            ...
            logger.debug("runtime: telemetry record failed: %s", exc)
